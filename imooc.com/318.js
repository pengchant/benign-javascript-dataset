...
var quesname="web前端框架选型疑问?请问数据展示及修改在angularJS,React,vue中选哪个好?";   //问答名称
    ...
    share : [{
            ...
            "onBeforeClick":function(cmd,config){
                ...
                return config;
                        ...
                        {
            "tag" : 'share_answer_330899',
            "bdUrl" : 'https://www.imooc.com/wenda/wdanswer/330899',
            "bdText":'[慕课猿问：web前端框架选型疑问?请问数据展示及修改在angularJS,React,vue中选哪个好? 回答者:繁花如伊 (分享自@慕课网)#慕课爱分享#'
        }
            ]
};
