...
var quesname="移动app和web app测试侧重点有哪些区别？";   //问答名称
    ...
    share : [{
            ...
            "onBeforeClick":function(cmd,config){
                ...
                return config;
                        ...
                        {
            "tag" : 'share_answer_335800',
            "bdUrl" : 'https://www.imooc.com/wenda/wdanswer/335800',
            "bdText":'[慕课猿问：移动app和web app测试侧重点有哪些区别？ 回答者:ABOUTYOU (分享自@慕课网)#慕课爱分享#'
        }
            ]
};
