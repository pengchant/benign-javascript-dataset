...
var quesname="关于一个vue2插件的部分源码疑惑";   //问答名称
    ...
    share : [{
            ...
            "onBeforeClick":function(cmd,config){
                ...
                return config;
                        ...
                        {
            "tag" : 'share_answer_353208',
            "bdUrl" : 'https://www.imooc.com/wenda/wdanswer/353208',
            "bdText":'[慕课猿问：关于一个vue2插件的部分源码疑惑 回答者:慕容4345310 (分享自@慕课网)#慕课爱分享#'
        }
            ]
};
