...
var quesname="java重定向与转发的问题";   //问答名称
    ...
    share : [{
            ...
            "onBeforeClick":function(cmd,config){
                ...
                return config;
                        ...
                        {
            "tag" : 'share_answer_513792',
            "bdUrl" : 'https://www.imooc.com/wenda/wdanswer/513792',
            "bdText":'[慕课猿问：java重定向与转发的问题 回答者:LEATH (分享自@慕课网)#慕课爱分享#'
        }
            ]
};
