...
var quesname="如何将python打包到应用中去？";   //问答名称
    ...
    share : [{
            ...
            "onBeforeClick":function(cmd,config){
                ...
                return config;
                        ...
                        {
            "tag" : 'share_answer_439407',
            "bdUrl" : 'https://www.imooc.com/wenda/wdanswer/439407',
            "bdText":'[慕课猿问：如何将python打包到应用中去？ 回答者:慕标琳琳 (分享自@慕课网)#慕课爱分享#'
        }
            ]
};
