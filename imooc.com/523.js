...
var quesname="大佬帮我看看这个错误用的是Spring Cloud+Mybatis plus";   //问答名称
    ...
    share : [{
            ...
            "onBeforeClick":function(cmd,config){
                ...
                return config;
                        ...
                        {
            "tag" : 'share_answer_359614',
            "bdUrl" : 'https://www.imooc.com/wenda/wdanswer/359614',
            "bdText":'[慕课猿问：大佬帮我看看这个错误用的是Spring Cloud+Mybatis plus 回答者:Caragana7 (分享自@慕课网)#慕课爱分享#'
        }
            ]
};
