...
var quesname="请问.net如何获取其他exe程序的icon图标资源？";   //问答名称
    ...
    share : [{
            ...
            "onBeforeClick":function(cmd,config){
                ...
                return config;
                        ...
                        {
            "tag" : 'share_answer_311920',
            "bdUrl" : 'https://www.imooc.com/wenda/wdanswer/311920',
            "bdText":'[慕课猿问：请问.net如何获取其他exe程序的icon图标资源？ 回答者:慕尼黑8549860 (分享自@慕课网)#慕课爱分享#'
        }
            ]
};
